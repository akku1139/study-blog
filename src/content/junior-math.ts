      ...
      lessons: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { type: 'heading', level: 3, content: '文字式の加法と減法——なぜ同類項をまとめるのか' },
            {
              type: 'text',
              content: '買い物の計算を考えてみます。300 円のノートを 2 冊と 300 円のペンを 3 本買うと $300 \\times 2 + 300 \\times 3$ 円ですが、これは $300 \\times (2 + 3) = 300 \\times 5$ 円と同じ。つまり**同じ単位のものは個数を先にたしてよい**。文字式でも同じで、$300$ を文字 $a$ に置き換えると $2a + 3a = 5a$ です。分配法則を逆向きに使っているだけで、文字と次数がそろう項——**同類項**——だけがまとめられます。',
            },
            {
              type: 'list',
              items: [
                '分配法則: $ka + ma = (k + m)a$（同類項だけ）',
                '減法は「ひく式のかっこを開いて符号を変える」: $A - (B - C) = A - B + C$',
                '$2a + 3b$ は $a$ と $b$ が別物なのでこれ以上まとめられない（リンゴとミカンの個数をたせないのと同じ）',
              ],
            },
            { type: 'formula', tex: '(7a - 4b) - (2a - 9b) = 7a - 4b - 2a + 9b = 5a + 5b', display: true },
            {
              type: 'note',
              variant: 'warn',
              content: '$3x^2$ と $3x$ は同類項ではありません。文字が同じでも**指数**が違えば、同じ文字部分を数えていることにはなりません。また $-(2a - 9b)$ は $-2a + 9b$。前のマイナスはかっこの中のすべての項にかかります。',
            },
            {
              type: 'example',
              title: '例題（同類項の整理）',
              body: '$5x - 3y - (2x - 8y)$ を簡単にせよ。',
              answer: '$5x - 3y - 2x + 8y = 3x + 5y$',
            },
            {
              type: 'example',
              title: '例題（代入の応用）',
              body: '測定値が $(x + y), (x - y), x$ の3つであるとき、平均を式で表し、誤差 $y$ が平均に現れないことを確かめよ。',
              answer: '分子は $(x + y) + (x - y) + x = 3x$（$+y$ と $-y$ が消える）なので平均は $\\dfrac{3x}{3} = x$。このように誤差がちょうど打ち消し合う場合の結果であり、一般の測定で平均をとれば誤差が必ず消えるわけではありません。',
            },
            { type: 'heading', level: 3, content: '手を動かす: ことばから式へ、式から値へ' },
            {
              type: 'text',
              content: '問題文を見たら **① 何がわかっていて何を求めるか（x にするものを決める）→ ② 関係を式に書く → ③ 代入して値を出す** の3ステップで動きます。たとえば「基本料金 200 円で 1 km あたり 50 円のタクシー」なら距離を x km とすると料金は $200 + 50x$ 円。式さえ作れば後は代入して機械的に値が出る、というのが文字式の強みです。',
            },
            {
              type: 'practice',
              title: '練習問題（解答つき）',
              problems: [
                {
                  body: '$4a - 7b + 3a + 2b$ を簡単にせよ。',
                  answer: '同類項をまとめて $(4 + 3)a + (-7 + 2)b =$ **$7a - 5b$**',
                },
                {
                  body: '$(6x - 5) - (2x - 11)$ を計算せよ。',
                  answer: '$6x - 5 - 2x + 11 =$ **$4x + 6$**',
                },
                {
                  body: '$x = -3$ のとき $\\dfrac{x^2 - 1}{x + 1}$ の値を求めよ（$x \\neq -1$）。',
                  hint: '負の数をかっこに入れ、分子と分母を別々に計算する。',
                  answer: '分子は $(-3)^2 - 1 = 8$、分母は $-3 + 1 = -2$。$8 \\div (-2) = -4$。分母が0になる値は代入できません。',
                },
                {
                  body: '1 枚 100 円のシールを a 枚、1 本 60 円の鉛筆を b 本買った。代金の合計を式で表し、$a = 5, b = 3$ のときの金額を求めよ。',
                  answer: '合計は $100a + 60b$ 円。代入すると $500 + 180 =$ **680 円**',
                },
              ],
            },
          ],
      ...
      lessons: [
        {
          ...
          blocks: [
            ...
            { type: 'heading', level: 3, content: '何を固定したかで関係が変わる' },
            { type: 'text', content: '同じ長方形でも、横を一定にして縦を伸ばせば面積は増えますが、面積を一定にして縦を伸ばせば横は縮みます。なぜ違うのでしょう。前者では「1 cm 伸ばすたびに同じ面積を足す」、後者では「決まった面積を細長く分け直す」からです。以下、長さ x は正とします。横3 cmで縦を x cm、面積を y cm²とすれば y＝3x。面積12 cm²で縦を x cm、横を y cmとすれば xy＝12です。' },
            { type: 'formula', tex: String.raw`y=ax\quad\Longleftrightarrow\quad \frac{y}{x}=a\ (x\ne0),\qquad xy=a\quad\Longleftrightarrow\quad y=\frac{a}{x}\ (x\ne0)`, display: true },
            { type: 'note', variant: 'warn', content: '商で比例を調べるときは x＝0を除きますが、比例の式 y＝ax 自体には x＝0を代入できます。反比例は a≠0 とし、x＝0を使えません。「片方が増えれば他方が減る」だけでは反比例とはいえません。たとえば y＝12−x は和が一定で、積は一定ではありません。また速さと時間が反比例するのは、移動距離を固定した場合です。' },
            { type: 'example', title: '例題：一定の速さと移動距離', body: '時速4 kmで一定に歩く。歩いた時間 x 時間と道のり y kmの関係を表し、45分で進む道のりを求めよ。休憩はしないものとする。', answer: '1時間に4 kmずつ進むので y＝4x。45分は45÷60＝0.75時間だから y＝4×0.75＝3、3 kmです。比例定数4の単位は km/時。時間と距離は0以上の範囲で考えます。' },
            { type: 'example', title: '例題：同じ道のりを違う速さで', body: '12 kmの道のりを一定の速さ x km/時で進むのに y 時間かかる。関係式を作り、時速3 kmと時速4 kmでの時間を比べよ。', answer: '速さ×時間＝道のりなので xy＝12、y＝12/x（x＞0）。時速3 kmなら4時間、時速4 kmなら3時間。速さは4/3倍、時間は3/4倍になり、積はどちらも12 kmです。' },
            { type: 'text', content: '表を作るときは、各列に x と y を1組ずつ書き、商と積を計算してみましょう。ただし数組が合うだけでは、まだ調べていない値でも成り立つ証明にはなりません。文章中の「一定の速さ」「同じ道のり」のような条件から式が成り立つ理由を確かめます。グラフにも現実の範囲だけを描き、時間が負の部分を歩行の記録として使わないようにします。' },
            { type: 'practice', title: '固定する量を見つける練習', problems: [
              { body: '1 mあたり80円のリボンを x m買う代金を y 円とする。式と、2.5 mの代金を求めよ。長さに比例して代金を計算し、追加料金はないものとする。', answer: '単価が一定なので y＝80x。80×2.5＝200より200円。xは0以上です。' },
              { body: '面積18 cm²の長方形で縦 x cm、横 y cmとする。式と、縦4 cmのときの横を求めよ。', answer: 'xy＝18より y＝18/x（x＞0）。横は18÷4＝4.5 cm。積を確認すると4×4.5＝18 cm²です。' },
              { body: 'x＝1, 2, 3に対して y＝11, 10, 9となる関係は反比例といえるか。', answer: 'いえません。積は11, 20, 27で一定ではありません。yが減ることだけでは反比例の条件を満たしません。' },
            ] },
          ],
        },
      ],
      ...
      lessons: [
        {
          ...
          blocks: [
            ...
            {
              type: 'example', title: '検算は両方の式へ代入する',
              body: '連立方程式 2x＋y＝7、x−y＝2 の候補として (x, y)＝(3, 1) が出た。この組は解か。',
              answer: '2×3＋1＝7、3−1＝2 なので両方を満たし、解です。一方 (2, 3) は最初の式だけを満たし、2−3＝−1 なので解ではありません。片方への代入だけでは検算になりません。',
            },
            {
              type: 'practice', title: '式を解く前に個数を考える',
              problems: [
                { body: 'x＋y＝3 と 2x＋2y＝8 を同時に満たす組はあるか。', answer: 'ありません。最初の式を2倍すると2x＋2y＝6となり、右辺8と矛盾します。2直線は平行です。' },
                { body: 'x＝2 と x＋y＝5 の解を求めよ。垂直な直線でも解を考えられるか。', answer: 'x＝2を代入するとy＝3。解は (2, 3) です。x＝2の傾きは定義できませんが、もう一方の直線との交点は求められます。' },
              ],
            },
            {
              type: 'text',
              content:
                '$\\begin{cases} ax + by = c \\\\ a\'x + b\'y = c\' \\end{cases}$ で、各式の x、y の係数が同時には0でないとき、各式は直線を表します。解の個数は2直線の位置関係です。傾き $-a/b$ は $b\\ne0$ の場合だけ使えますが、次の係数による判定なら垂直な直線も扱えます。',
            },
            {
              type: 'list',
              items: [
                '$a b\' - a\' b \\neq 0$: **交点 1 つ**（解はただ 1 つ）。垂直な直線と交わる場合も含む',
                'x、y の係数が同じ倍率で比例するが、右辺の定数はその倍率で比例しない → **平行**（解なし）',
                'x、y の係数と右辺の定数がすべて同じ倍率で比例する → **一致**（解は無数にある）',
              ],
            },
            {
              type: 'note',
      ...
      lessons: [
        {
          ...
          blocks: [
            ...
            {
              type: 'text',
              content: '$y$ が $x$ の二次式で表される関数を**二次関数**といいます。以下では $a \\neq 0$ とします。中学での基本は $y = ax^2$ で、グラフは**放物線**です。平行移動した形や平方完成は高校につながる発展として扱います。',
            },
             { type: 'formula', tex: 'y = ax^2, \\qquad y = a(x - p)^2 + q', display: true },
            { type: 'heading', level: 3, content: '基本：係数・変域・変化の割合' },
            {
              type: 'text',
              content: '$y = ax^2$ は $y$ 軸について対称で、$a > 0$ なら上に、$a < 0$ なら下に開きます。変域は端点の値だけでなく、**区間に $x = 0$ が含まれるか**を確認します。変化の割合は「$y$ の増加量 ÷ $x$ の増加量」で、比例定数 $a$ そのものとは限りません。',
            },
            {
              type: 'example',
              title: '基本例題：負の数を含む変域',
              body: '$y = ax^2$ が点 $(2, 8)$ を通る。(1) $a$ を求めよ。(2) $-1 \\le x \\le 3$ のときの $y$ の変域を求めよ。(3) $x$ が $-1$ から $3$ まで増加するときの変化の割合を求めよ。',
              answer: '(1) $8 = 4a$ より $a = 2$。(2) 区間に $0$ が含まれるので最小値は $x = 0$ のとき $0$。端点の値は $2$ と $18$ なので最大値は $18$。よって $0 \\le y \\le 18$。(3) $(18 - 2) \\div (3 - (-1)) = 4$。',
            },
            {
              type: 'practice',
              title: '基本の練習問題（解答つき）',
              problems: [
                {
                  body: '$y = -x^2$ で $-2 \\le x \\le 1$ のとき、$y$ の変域と、$x$ が $-2$ から $1$ まで増加するときの変化の割合を求めよ。',
                  hint: '頂点と両端の値を調べる。変化の割合では始点と終点の値を使う。',
                  answer: '$x = -2, 0, 1$ で $y = -4, 0, -1$。変域は $-4 \\le y \\le 0$。変化の割合は $(-1 - (-4)) \\div (1 - (-2)) = 1$。',
                },
                {
                  body: '$y = 2x^2$ で $1 \\le x \\le 3$ のときの $y$ の変域を求めよ。',
                  answer: 'この区間に $x = 0$ は含まれず、$x$ とともに $y$ は増加する。端点で $y = 2, 18$ なので $2 \\le y \\le 18$。最小値を $0$ にしないこと。',
                },
              ],
            },
            { type: 'heading', level: 3, content: '発展：放物線の平行移動' },
            {
              type: 'table',
              headers: ['式', '頂点', '軸'],
              rows: [
            ...
            },
            {
              type: 'note',
              variant: 'warn',
              content: '$x$ 軸との共有点は $y = 0$ とおいて調べます。$y = a(x-p)^2 + q$ なら $(x-p)^2 = -q/a$ なので、右辺が正なら2点、0なら1点、負なら0点です。高校では一般形の判別式 $D = b^2 - 4ac$ でも判定します。',
            },
            { type: 'heading', level: 3, content: '発展：平方完成——一般形を頂点の形へ' },
            {
              type: 'text',
              content:
                '$y = ax^2 + bx + c$（$a \\neq 0$）を **平方完成**して、平方の項と定数の和にすると頂点が読み取れます。因数分解のたすきがけとは別の操作です。たとえば $x^2 - 6x$ に $9$ を足すと $(x-3)^2$ になるので、同時に $9$ を引いて式の値を保ちます。',
            },
      ...
      lessons: [
        {
          ...
          blocks: [
            ...
            { type: 'heading', level: 4, content: '見た目ではなく、形が一つに決まる理由を探す' },
            { type: 'text', content: '地図を拡大すると三角形の角度は変わりませんが、辺の長さは変わります。だから「同じ形に見える」だけでは、ぴったり重なるとは限りません。厚紙の三角形を裏返す場合も含め、移動して重ねられる関係が合同です。証明では実際に切り取らず、三角形の形と大きさを決める条件がそろうことを示します。' },
            { type: 'text', content: 'たとえば長さ4 cmと6 cmの棒の一端をつなぐと、開き方によって端同士の距離が変わります。2辺が同じだけでは三角形は決まりません。しかしその間の角を50°に固定すれば、残りの辺も決まります。これが「2組の辺とその間の角」という合同条件の直感です。角はどこでもよいわけではありません。' },
            { type: 'note', variant: 'warn', content: '図で同じ長さに見えても、仮定や既に示した性質でなければ根拠にできません。また △ABC≡△DEF は A↔D、B↔E、C↔F という対応まで表します。対応を書き出してから辺や角を比べましょう。合同から導きたい辺の等しさを、合同を示すための根拠に使うのは循環した説明です。' },
            { type: 'example', title: '例題：共通の辺を見落とさない', body: '四角形ABCDで AB＝AD、BC＝DC とする。対角線ACを引いたとき △ABC≡△ADC を示し、∠BAC＝∠DAC を導け。', answer: '△ABCと△ADCで AB＝AD、BC＝DCは仮定、AC＝ACは共通の辺。3組の辺がそれぞれ等しいので合同です。対応する角は等しいので∠BAC＝∠DAC。角の等しさは合同を示した後の結論です。' },
            { type: 'example', title: '例題：合同の順番から対応を読む', body: '△PQR≡△XYZ で PQ＝5 cm、QR＝7 cm、∠R＝40°である。XY、YZ、∠Z を求めよ。', answer: '頂点の対応はP↔X、Q↔Y、R↔Z。対応する辺・角は等しいのでXY＝5 cm、YZ＝7 cm、∠Z＝40°です。紙の上で上下が逆でも、この対応は変わりません。' },
            { type: 'text', content: '自分で証明するときは、左右に2つの三角形の名前を書き、対応する辺の組を線で結んでみましょう。仮定に印をつけた後、「共通の辺はあるか」「平行線の角は使えるか」を探します。条件が2つしかないなら、無理に結論を書かず不足している条件を特定するのが次の一手です。' },
            { type: 'practice', title: '根拠と対応の練習', problems: [
              { body: '△ABCと△DEFでAB＝DE、AC＝DFがわかる。2辺とその間の角で合同を示すには、どの角の等しさが必要か。', answer: '∠BAC＝∠EDFです。どちらも既知の2辺が出会う頂点の角なので「その間の角」になります。' },
              { body: '△ABC≡△FDE とする。辺BCと角Aに対応するものを答えよ。', answer: 'A↔F、B↔D、C↔Eなので、辺BCには辺DE、角Aには角Fが対応します。' },
              { body: 'AB＝ACの三角形で、Dは辺BCの中点とする。△ABD≡△ACDを示せ。', answer: 'AB＝ACは仮定、BD＝CDは中点の定義、AD＝ADは共通の辺。3組の辺がそれぞれ等しいので合同です。ADが垂直と図だけで決めつける必要はありません。' },
            ] },
            {
              type: 'text',
            ...
            },
            {
              type: 'example',
              title: '例題',
              body: 'AB = AC の二等辺三角形 ABC で、辺 BC の内部に BD = CE となる点 D, E をとる。△ABD ≡ △ACE を証明せよ。',
              answer: '△ABD と △ACE で、① AB = AC（仮定）、② BD = CE（仮定）、③ ∠ABD = ∠ACE（二等辺三角形の底角が等しく、D, E は辺 BC の内部にある）。よって **2組の辺とその間の角がそれぞれ等しい**ので △ABD ≡ △ACE。',
            },
            {
              type: 'practice',
              title: '練習問題',
        ...
        },
        {
          ...
          blocks: [
            ...
            { type: 'heading', level: 3, content: '平行線で相似な三角形をつくる' },
            {
              type: 'text',
              content: '三角形 ABC の辺 AB, AC の内部に点 D, E をとり、DE と BC が平行なら、同位角より ∠ADE = ∠ABC、∠AED = ∠ACB です。**2組の角がそれぞれ等しい**ので △ADE ∽ △ABC。対応は A ↔ A、D ↔ B、E ↔ C で、AD : AB = AE : AC = DE : BC となります。直角が1組等しいだけでは相似とはいえません。',
            },
            {
              type: 'example',
              title: '例題：小三角形と残りの部分',
              body: '上の図形で AD = 4 cm、DB = 2 cm、AC = 9 cm、BC = 12 cm とする。AE、EC、DE を求めよ。',
              answer: 'AB = 4 + 2 = 6 cm より相似比は AD : AB = 2 : 3。AE = 9 × 2/3 = 6 cm、EC = 9 − 6 = 3 cm、DE = 12 × 2/3 = 8 cm。AD : DB ではなく AD : AB を使う。',
            },
            {
              type: 'practice',
              title: '練習問題',
              problems: [
                ...
                {
                  body: '△ABC で D は辺 AB の内部、E は辺 AC の内部にあり DE ∥ BC。AD : AB = 2 : 5、△ABC の面積が 50 cm² のとき、△ADE と四角形 DBCE の面積を求めよ。',
                  answer: '面積比は $2^2 : 5^2 = 4 : 25$。△ADE は $50 \\times 4/25 = 8$ cm²、残りの四角形 DBCE は $50 - 8 = 42$ cm²。',
                },
                {
      ...
      lessons: [
        {
          ...
          blocks: [
            ...
            {
              type: 'text',
              content: '**直角三角形**で、直角をはさむ辺を $a, b$、直角の向かいの辺（斜辺）を $c$ とします。斜辺は最も長い辺です。直角でない三角形に、そのまま三平方の定理を使ってはいけません。',
            },
            ...
            },
            {
              type: 'example',
              title: '例題：斜辺以外の辺を求める',
              body: '直角三角形の斜辺が 13 cm、直角をはさむ一辺が 5 cm のとき、もう一辺を求めよ。',
              answer: '求める長さを $x$ cm とすると $5^2 + x^2 = 13^2$。$x^2 = 169 - 25 = 144$。長さは正なので $x = 12$、答えは **12 cm**。斜辺の平方から既知の辺の平方を引く。',
            },
            {
              type: 'practice',
              title: '練習問題（解答つき）',
              problems: [
                {
                  body: '縦 6 cm、横 8 cm の長方形の対角線の長さを求めよ。',
                  answer: '対角線でできる直角三角形より $d^2 = 6^2 + 8^2 = 100$。$d > 0$ なので **10 cm**。',
                },
                {
                  body: '一辺 6 cm の正三角形の高さと面積を求めよ。',
                  hint: '高さを引くと底辺が 3 cm ずつに分かれ、斜辺が 6 cm の直角三角形ができる。',
                  answer: '高さ $h$ は $h^2 = 6^2 - 3^2 = 27$ より $3\\sqrt{3}$ cm。面積は $6 \\times 3\\sqrt{3} \\div 2 = 9\\sqrt{3}$ cm²。',
                },
                {
                  body: '縦 3 cm、横 4 cm、高さ 12 cm の直方体の、向かい合う頂点を結ぶ空間の対角線の長さを求めよ。',
                  answer: '底面の対角線は $\\sqrt{3^2+4^2}=5$ cm。それと高さでできる直角三角形より、空間の対角線は $\\sqrt{5^2+12^2}=13$ cm。三平方の定理を2回使う。',
                },
              ],
            },
            {
      ...
      lessons: [
        {
          ...
          blocks: [
            ...
            { type: 'heading', level: 4, content: '結果の名前ではなく、起こり方を数える' },
            { type: 'text', content: '袋に赤いカードが3枚、青いカードが1枚入っているとき、「赤か青の2種類だから赤の確率は半分」と考えてよいでしょうか。色の名前は2つでも、赤を引く起こり方は3つあります。カードを1枚ずつ区別すると、なぜ赤が出やすいかが見えます。確率の計算は、まず同じ起こりやすさの小さな場合に分ける作業から始まります。' },
            { type: 'text', content: '考えられる結果をすべて集めたものが全事象、条件に合う結果を集めたものが事象です。どのカードも等しい確率で選ぶなら、上の全事象は4通り、赤という事象は3通り。全体の何割を占めるかを求めるので、赤の確率は3/4です。' },
            { type: 'note', variant: 'warn', content: '確率が1/2でも、2回試せば必ず1回成功するわけではありません。試行回数が少ないと結果の割合は大きくばらつきます。また「同様に確からしい」と「独立」は別の条件。前者は結果同士の起こりやすさ、後者は前の結果が次の確率を変えないことです。戻さず引く場合は通常、独立ではありません。' },
            { type: 'example', title: '例題：同じ文字のカードを区別する', body: 'A、A、Bと書いた3枚から、どの1枚も等しい確率で1枚選ぶ。Aを引く確率を求めよ。', answer: '2枚のAをA₁、A₂と区別すると、全体はA₁、A₂、Bの3通りで、Aは2通り。確率は2/3です。「AかBか」の2通りは同様に確からしくありません。' },
            { type: 'example', title: '例題：2回の結果を漏れなく書く', body: '表と裏が等しい確率で出るコインを独立に2回投げる。ちょうど1回表になる確率を求めよ。', answer: '（1回目, 2回目）は（表, 表）（表, 裏）（裏, 表）（裏, 裏）の4通りで、各確率は1/4。条件に合うのは中央の2通りなので2/4＝1/2です。「表が0回、1回、2回」を同じ確率だとは扱えません。' },
            { type: 'text', content: '紙に最初の結果を固定して書き、その右に次の結果を順に並べてみましょう。各枝で選択肢の数が変わる場合は、末端の数だけで割ってよいかを再確認します。最後に「条件に合う場合＋合わない場合＝全場合」「答えは0以上1以下」の2つを確かめると、数え落としを見つけやすくなります。' },
            { type: 'practice', title: '同様に確からしい場合を作る練習', problems: [
              { body: '1～5のカードを1枚ずつ用意し、等しい確率で1枚引く。3以上の数を引く確率は？', answer: '全5通りのうち3、4、5の3通りなので3/5。条件に合わない1、2の2通りと合わせて5通りです。' },
              { body: '表と裏が等しい確率のコインを独立に3回投げる。すべて裏になる確率は？', answer: '順序を区別すると全体は2×2×2＝8通りで同様に確からしく、裏・裏・裏は1通り。確率は1/8です。' },
              { body: '赤2枚・青1枚から等しい確率で1枚ずつ、戻さず2枚引く。2枚とも赤の確率は？', answer: 'カードを区別した順序つきの結果は3×2＝6通りで同様に確からしい。赤2枚の順番は2通りなので2/6＝1/3です。2/3を2回掛けると、戻さない条件を無視することになります。' },
            ] },
            ...
            { type: 'heading', level: 3, content: '同時に/続けて取り出す' },
            {
              type: 'list',
              items: [
                'どの玉も同様に確からしく選ぶとき、**同時**に2個取り出すのと**戻さず続けて**2個取り出すのは、順序を区別しない結果の確率が同じ',
            ...
            },
            {
              type: 'example',
              title: '例題',
              body: '白玉4個・赤玉2個が入った袋から、どの2個の組も同様に確からしく、同時に2個取り出す。2個とも白である確率を求めよ。',
              answer: '玉を1個ずつ区別して数える。すべての組は $6 \\times 5 \\div 2 = 15$ 通り、白2個の組は $4 \\times 3 \\div 2 = 6$ 通り。どちらも順序を重複して数えた分を2で割る。よって $P = 6/15 = 2/5$。',
            },
            {
              type: 'example',
              title: '例題（余事象）',
              body: '各目が同様に確からしいサイコロを独立に2回投げるとき、少なくとも1回 4 以上の目が出る確率を求めよ。',
              answer: '余事象は「両方とも 3 以下」＝ $3^2 = 9$ 通り / 全体 $36$。$P = 1 - \\dfrac{9}{36} = \\dfrac{27}{36} = \\dfrac{3}{4}$',
            },
            {
              type: 'example',
              title: '例題：和が同じでも場合の数は違う',
              body: '各目が同様に確からしい大小2個のサイコロを独立に投げる。目の和が 7 になる確率を求めよ。',
              answer: '（大, 小）の順序つきの組は $6 \\times 6 = 36$ 通りで同様に確からしい。和が7の組は $(1,6),(2,5),(3,4),(4,3),(5,2),(6,1)$ の6通りなので $6/36 = 1/6$。和の2〜12を11通りとして割ってはいけない。和の起こりやすさは等しくない。',
            },
            {
              type: 'practice',
              title: '練習問題',
              problems: [
                {
                  body: '1, 2, 3 の数字カードが1枚ずつ入った袋から、1枚引くたびに戻してよく混ぜ、計2回引く。毎回どのカードも同様に確からしいとき、2回とも偶数になる確率を求めよ。',
                ...
                {
                  body: '10 本のくじのうち当たりが 3 本。A, B の順に1本ずつ、引いたくじを戻さずに引く。各回で残りのくじは同様に確からしく選ばれるとき、B が当たる確率を求めよ。',
                  hint: 'A の結果で場合分けする。',
                  answer: '$\\dfrac{3}{10} \\times \\dfrac{2}{9} + \\dfrac{7}{10} \\times \\dfrac{3}{9} = \\dfrac{6+21}{90} = $ **$\\dfrac{3}{10}$**。くじは引く順番によらず公平。',
                },
                {
                  body: '各目が同様に確からしい大小2個のサイコロを独立に投げる。目の和が 4 以下になる確率を求めよ。',
                  hint: '和が2、3、4の組を順序を区別して数える。',
                  answer: '和が2は $(1,1)$、和が3は $(1,2),(2,1)$、和が4は $(1,3),(2,2),(3,1)$。計6通りなので $6/36 = 1/6$。',
                },
                {
                  body: '白玉3個、赤玉2個から、どの2個の組も同様に確からしく同時に2個取り出す。少なくとも1個が赤である確率を求めよ。',
                  answer: '全体は $5 \\times 4 \\div 2 = 10$ 通り。「赤が0個」、つまり白2個は $3 \\times 2 \\div 2 = 3$ 通り。余事象を使い $1 - 3/10 = 7/10$。',
                },
              ],
            },
        ...
        },
        {
          ...
          blocks: [
            ...
            { type: 'heading', level: 4, content: '一部が全体の縮図になるためには' },
            { type: 'text', content: 'スープの味を一口で確かめるなら、よく混ざった部分を味わう必要があります。統計でも、一部を調べること自体より「その一部がどう選ばれたか」が重要です。図書室にいる生徒だけに読書について聞くと、読書好きが多く含まれるかもしれません。調べる人数を増やしても、図書室だけで選ぶ偏りは残ります。' },
            { type: 'text', content: '全校生徒の読書習慣を知りたいなら母集団は全校生徒で、実際に調べた人々が標本です。たとえば全校の名簿から重複なくランダムに選ぶ単純無作為抽出なら、誰もが同じ確率で選ばれます。ただし選ばれた人の回答率が低く、その理由が読書習慣と関係すれば、回答者だけの集計には別の偏りが生じます。' },
            { type: 'note', variant: 'warn', content: '無作為に選んでも、標本が毎回同じ割合になるわけではありません。「選び方の偏り」と「偶然のばらつき」は区別します。標本を大きくすると一般に後者は小さくなりますが、前者は自動的には直りません。以下の人数や回答は計算を学ぶための架空データで、現実の学校の傾向を示すものではありません。' },
            { type: 'example', title: '例題：標本の割合を人数に読み替える', body: '架空の学校の全校生徒600人から無作為に60人選び、全員が回答した。うち18人が徒歩通学だった。全校の徒歩通学者を推定せよ。', answer: '標本割合は18÷60＝0.3。全校も同じくらいの割合と推測して600×0.3＝180、約180人です。実際に全員を数えた値ではないので、ちょうど180人とは断定しません。' },
            { type: 'example', title: '例題：人数が多いだけで信頼できるか', body: '全校600人の読書習慣を知るため、A案では読書クラブのメンバー100人、B案では全校名簿から無作為に60人を選び、全員に回答してもらう。選び方の観点ではどちらが適切か。', answer: 'B案です。A案は読書に関心の強い集団に限られ、母集団全体とは特徴が違うおそれがあります。100人という人数だけでA案が優れているとはいえません。ただしB案も偶然のばらつきは残るため、正確な全校割合を保証するわけではありません。' },
            { type: 'text', content: '推定問題では、まず母集団と標本に別々の丸をつけ、人数と該当人数を整理しましょう。標本の該当人数を母集団の人数で割るのではなく、「標本の該当人数÷標本の人数」を先に求めます。結果には「約」をつけ、誰が選ばれなかった可能性があるかも一言添えると、計算と調査の質を両方点検できます。' },
            { type: 'practice', title: '推定と限界を説明する練習', problems: [
              { body: '架空の全校800人から無作為に80人調べ、全員回答のうち自転車通学が12人だった。全校の自転車通学者を推定せよ。', answer: '12÷80＝0.15、800×0.15＝120なので約120人。標本に基づく推定であり、全数調査の結果ではありません。' },
              { body: '昼休みに運動場にいる生徒だけに運動時間を聞き、全校の運動時間を推定する方法の問題点は？', answer: '運動する生徒が選ばれやすく、教室などにいる生徒が含まれにくい選び方です。場所による偏りがあり、回答者を増やすだけでは解消しません。' },
              { body: '同じ母集団から別々に無作為抽出した標本で、ある回答が20/50と23/50だった。違いだけで片方の調査に不正があるといえるか。', answer: 'いえません。割合は40%と46%ですが、無作為抽出でも偶然のばらつきがあります。この差だけで不正や母集団の変化を断定できません。' },
            ] },
            {
              type: 'text',
            ...
            { type: 'formula', tex: '\\text{標本での割合} \\approx \\text{母集団での割合}', display: true },
            {
              ...
              items: [
                ...
                '**偏りのない方法なら、標本が大きいほど**一般に偶然によるばらつきは小さくなる。ただし選び方の偏りは数を増やすだけでは解消しない',
            ...
            },
            {
              type: 'example',
              title: '例題',
              body: '池の魚 60 匹に印をつけて放した。数日後にもう一度 50 匹捕まえたところ印付きが 10 匹いた。魚の総数は変わらず、印は消えず、十分に混ざってどの魚も同程度に捕まりやすいと仮定し、総数を推測せよ（標識再捕法）。',
              answer: '総数を $x$ 匹として、印付きの割合 $60/x \\approx 10/50$ と考える。$x \\approx 60 \\times 50/10 = 300$ より **約300匹**。標本による推定であり、ちょうど300匹と断定はできない。',
            },
            {
              type: 'practice',
              title: '練習問題',
              problems: [
                ...
                },
                {
                  ...
                  answer: '**偏り（バイアス）**が生じるおそれがある。クラスごとの特徴を強く反映するため、全校生徒の傾向とずれることがある。母集団全体から無作為に選ぶことが重要。',
                },
              ],
            },
            {
      ...
      lessons: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { type: 'heading', level: 4, content: '回す向きと中心がないと移動は決まらない' },
            { type: 'text', content: '時計の針を90°動かすとき、右へ回すか左へ回すかで止まる場所は変わります。また紙の角を押さえて回す場合と中央を押さえて回す場合も違います。回転を正しく伝えるには「中心・角度・向き」の3つが必要です。このレッスンで原点のまわり90°とだけ書く箇所は、反時計回りを意味します。270°も反時計回りで、時計回り90°と同じ到着点になります。' },
            { type: 'text', content: '対称移動は鏡の向こうの点を探す操作です。点と移った点を結ぶ線分を、対称の軸が垂直に二等分します。たとえば縦の直線 x＝2から右に3離れた点は、左に3離れた点へ移ります。原点や座標軸だけでなく、どの位置の鏡でも「軸から同じ距離」が基本です。' },
            { type: 'note', variant: 'warn', content: '原点からの距離が同じという条件だけでは回転後の点は決まりません。同じ円周上に無数の候補があるからです。90°という角度と回す向きも確認します。また平行移動・回転は三角形の頂点をたどる向きを保ちますが、対称移動はその向きを逆にします。いずれも辺の長さと角の大きさは変わりません。' },
            { type: 'example', title: '例題：座標軸ではない鏡', body: '点P(5, −1)を直線 x＝2について対称移動した点Qを求めよ。', answer: 'Pは軸の右に5−2＝3だけ離れています。Qは左に3なのでx座標は2−3＝−1、y座標は変わらず−1。Q(−1, −1)です。中点のx座標は(5＋(−1))÷2＝2で軸上にあります。' },
            { type: 'example', title: '例題：原点でない中心の回転', body: '点P(3, 2)をC(1, 1)のまわりに反時計回り90°回転した点Qを求めよ。', answer: 'Cを基準にしたPの位置は(3−1, 2−1)＝(2, 1)。これを90°回すと(−1, 2)。中心の座標を戻してQ(1−1, 1＋2)＝Q(0, 3)です。中心から見て右2・上1が、左1・上2になります。' },
            { type: 'text', content: '手を動かすときは方眼紙に中心や軸を先に書きます。回転では「中心を原点だと思った相対的な位置→回転→元の座標へ戻す」、対称移動では「軸からの距離→反対側の同じ距離」と順に処理します。最後に距離が保たれているかを確認します。ただし距離が合うだけでは不十分なので、向きも図で確認しましょう。' },
            { type: 'practice', title: '中心・軸・向きを確かめる練習', problems: [
              { body: '点(2, 5)を原点のまわりに時計回り90°回転した点を求めよ。', answer: '(5, −2)です。時計回りでは(x, y)→(y, −x)。反時計回りの答え(−5, 2)と区別します。' },
              { body: '点(−2, 4)を直線 y＝1について対称移動した点を求めよ。', answer: '(−2, −2)です。軸より上に4−1＝3なので、移動後は下に3、y＝1−3＝−2。x座標は変わりません。' },
              { body: '点(4, 0)を中心C(1, −1)のまわりに180°回転した点を求めよ。', answer: '中心からの相対的な位置は(3, 1)。180°回転で(−3, −1)になるので、中心の座標を戻すと(−2, −2)です。元の点と移動後の点の中点はCになります。' },
            ] },
            {
              type: 'text',
        ...
        // ---------- 発展: 一次関数と二次関数の比較 ----------
        {
          ...
          blocks: [
            ...
            {
              type: 'text',
              content: '2 数の和が一定なら、積は2数が等しいときに最大になります。ただし、その値が問題の条件で許されるかを確認します。たとえばタテとヨコの和が 10 の長方形なら、タテを $x$、ヨコを $10-x$ として $0 < x < 10$。面積 $S = x(10-x)$ の頂点 $x = 5$ はこの範囲に入ります。ほかの面積最大問題でも、まず式と変域を作り、頂点が変域内にあるかを調べましょう。',
            },
            {
              type: 'derivation',
              ...
              steps: [
                {
                  ...
                  note: '$x^2$ の係数がマイナスなので、放物線は下に開き、頂点で最大値をもちます。',
                },
                {
                  label: 'Step 2: 平方完成する',
        ...
        // ---------- 発展: 資料の整理 ----------
        {
          ...
          blocks: [
            ...
            {
              type: 'example', title: '一つの値が変わると平均と中央値はどう動く？',
              body: '5人の読書時間が10、10、20、20、40分だった。40分を100分に訂正したとき、平均値と中央値はどう変わるか。',
              answer: '訂正前の平均は100÷5＝20分、訂正後は160÷5＝32分。中央値はどちらも小さい順の3番目なので20分です。平均はすべての値を使うため極端な値の影響を受けます。中央値だけでは合計や大きな値の変化は分かりません。',
            },
            {
              type: 'practice', title: '代表値を根拠とともに選ぶ',
              problems: [
                { body: 'データ2、3、3、4、18の平均値・中央値・最頻値を求めよ。', answer: '平均値は30÷5＝6、中央値は3、最頻値も3です。18という大きな値が平均を押し上げています。' },
                { body: '5個のデータで平均値が6と分かるとき、合計はいくつか。中央値が6という情報だけでも同じ合計が分かるか。', answer: '平均値6なら合計は6×5＝30です。中央値6だけでは合計は決まりません。1、2、6、7、8も、1、2、6、7、100も中央値は6ですが合計は異なります。' },
              ],
            },
            {
              type: 'table',
